                ...
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-center text-sm">
                    {item.prices.wash_fold?.price ? (
                      <span className="text-gray-800 font-medium">Rp{item.prices.wash_fold.price}</span>
                    ) : <span className="text-gray-300">-</span>}
                  </td>
                  <td className="px-4 py-3 text-center text-sm">
                    {item.prices.wash_iron?.price ? (
                      <span className="text-gray-800 font-medium">Rp{item.prices.wash_iron.price}</span>
                    ) : <span className="text-gray-300">-</span>}
                  </td>
                  <td className="px-4 py-3 text-center text-sm">
                    {item.prices.dry_clean?.price ? (
                      <span className="text-gray-800 font-medium">Rp{item.prices.dry_clean.price}</span>
                    ) : <span className="text-gray-300">-</span>}
                  </td>
                  <td className="px-4 py-3 text-center text-sm">
                    {item.prices.steam_press?.price ? (
                      <span className="text-gray-800 font-medium">Rp{item.prices.steam_press.price}</span>
                    ) : <span className="text-gray-300">-</span>}
                  </td>
                  <td className="px-4 py-3 text-center text-sm">
                    {item.prices.starching?.price ? (
                      <span className="text-gray-800 font-medium">Rp{item.prices.starching.price}</span>
                    ) : <span className="text-gray-300">-</span>}
                  </td>
                  <td className="px-4 py-3 text-center text-sm">
                    {item.prices.alteration?.price ? (
                      <span className="text-gray-800 font-medium">Rp{item.prices.alteration.price}</span>
                    ) : <span className="text-gray-300">-</span>}
                  </td>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Prices (Rp) - Enter price for each service
                    </label>
