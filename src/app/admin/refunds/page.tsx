                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-2xl font-bold text-gray-900 mb-2">
                          Rp{refund.amount.toLocaleString()}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 text-sm text-gray-600">
                          ...
                          <div className="flex items-center">
                            ...
                            Order: Rp{refund.order?.pricing?.total?.toLocaleString()}
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
              <p className="text-sm text-yellow-800">
                <AlertTriangle className="w-4 h-4 inline mr-1" />
                This refund exceeds your approval limit of Rp500. It will be escalated to Center Admin for approval.
              </p>
            </div>
            <div className="space-y-4">
              <div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-green-600">Rp{selectedRefund.amount.toLocaleString()}</p>
                </div>
                <div>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2 font-medium">Rp{selectedRefund.order?.pricing?.total?.toLocaleString() || 'N/A'}</span>
                  </div>
                </div>
              </div>
