                  ...
                  {getCurrentItemTypes().map((item) => (
                    <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Rp{item.basePrice}</p>
                      </div>
                ...
                <div className="mt-4 p-3 bg-teal-50 rounded-lg">
                  ...
                  {calculatedPricing && (
                    <div className="flex justify-between text-sm mt-1">
                      ...
                      <span className="font-bold text-teal-600">Rp{getCalculatedTotal()}</span>
                    </div>
                  )}
                </div>
              )}
                ...
                <div className="flex items-center text-sm text-teal-600 mt-1">
                  ...
                  {getServiceTypeDiscount() > 0 && (
                    <span className="ml-2 text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">
                      Save Rp{getServiceTypeDiscount()}
                    </span>
                  )}
                </div>
              </div>
                ...
                <div className="text-center py-8">
                  ...
                  <div className="mt-4 p-3 bg-green-50 rounded-lg">
                    <p className="text-sm text-green-700">
                      🎉 You save Rp{getServiceTypeDiscount()} with self service!
                    </p>
                  </div>
                </div>
              )}
                            ...
                            <>
                              ...
                              {getServiceTypeDiscount() > 0 && (
                                <div className="text-sm text-green-600 mt-1">
                                  🎉 Self service discount: Rp{getServiceTypeDiscount()}
                                </div>
                              )}
                            </>
                          ) : (
                  ...
                  <div className="p-4 bg-teal-50 rounded-lg">
                    ...
                    <div className="flex justify-between font-bold">
                      ...
                      <span className="text-teal-600">
                        Rp{Math.max(0, getCalculatedTotal() + (serviceType !== 'self_drop_self_pickup' ? (deliveryInfo?.deliveryCharge || 0) : 0) - getServiceTypeDiscount())}
                      </span>
                    </div>
                  </div>
                )}
