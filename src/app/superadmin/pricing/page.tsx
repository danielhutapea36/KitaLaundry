                ...
                <tr key={config._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                      ...
                      <div>Min Order: Rp{config.settings.minimumOrderValue}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                  ...
                  <div key={index} className="bg-gray-50 p-3 rounded">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        <div className="font-medium">Rp{item.basePrice}</div>
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        <div className="font-medium">
                          {policy.type === 'percentage' ? `${policy.value}%` : `Rp${policy.value}`}
                        </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 p-4 rounded space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">Rp{config.settings.minimumOrderValue}</span>
                </div>
                <div className="flex justify-between">
                  <span>Free Delivery Threshold:</span>
                  <span className="font-medium">Rp{config.settings.deliveryCharges.freeDeliveryThreshold}</span>
                </div>
                <div className="flex justify-between">
                  <span>Standard Delivery:</span>
                  <span className="font-medium">Rp{config.settings.deliveryCharges.standardCharge}</span>
                </div>
                <div className="flex justify-between">
                  <span>Express Delivery:</span>
                  <span className="font-medium">Rp{config.settings.deliveryCharges.expressCharge}</span>
                </div>
              </div>
            </div>
                ...
                {config.expressCharges.map((charge, index) => (
                  <div key={index} className="bg-gray-50 p-3 rounded">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        <div className="font-medium">
                          {charge.type === 'percentage' ? `${charge.value}%` : `Rp${charge.value}`}
                        </div>
                        <div className="text-sm text-gray-600">
