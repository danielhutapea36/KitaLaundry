                ...
                <div className="flex items-center space-x-4">
                  <div className="text-right">
                    ...
                    <div className="text-xs text-gray-500">
                      Rp{Math.round((order.totalAmount || 0) / displayItems)} per item
                    </div>
                  </div>
      ...
      {safeOrders.length > 0 && (
        <div className="mt-6 pt-4 border-t border-gray-200">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-gray-900">
                Rp{safeOrders.reduce((sum, order) => sum + (order.totalAmount || 0), 0).toLocaleString()}
              </div>
              <div className="text-xs text-gray-500">Total Value</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-gray-900">
                Rp{Math.round(safeOrders.reduce((sum, order) => sum + (order.totalAmount || 0), 0) / (safeOrders.length || 1)).toLocaleString()}
              </div>
