...
const SERVICE_TYPES = [
  ...
  { id: 'self_drop_self_pickup', title: 'Self Drop & Pickup', subtitle: 'Drop & Pickup at Branch', icon: 'building', discount: 50, discountLabel: 'Save upto Rp50' },
  { id: 'self_drop_home_delivery', title: 'Self Drop + Delivery', subtitle: 'Drop at Branch + Home Delivery', icon: 'home', discount: 25, discountLabel: 'Save upto Rp25' },
  { id: 'home_pickup_self_pickup', title: 'Pickup + Self Collect', subtitle: 'Home Pickup + Collect from Branch', icon: 'package', discount: 25, discountLabel: 'Save upto Rp25' },
]
                      ...
                      {getCurrentItems().map((item) => (
                        <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                          <div>
                            ...
                            <p className="text-sm text-teal-600">Rp{item.basePrice}</p>
                          </div>
                          <div className="flex items-center gap-2">
                      ...
                      <div className="p-4 bg-teal-50 rounded-xl">
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-2xl font-bold text-teal-600">Rp{getTotalPrice()}</p>
                          </div>
                        </div>
                      </div>
                    </>
                  ...
                  {serviceType === 'self_drop_self_pickup' ? (
                    <div className="text-center py-6">
                      ...
                      <div className="mt-4 p-3 bg-green-50 rounded-xl">
                        <p className="text-sm text-green-700">🎉 You save Rp{getServiceTypeDiscount()} with self service!</p>
                      </div>
                    </div>
                  ) : (
                    <>
                          ...
                          {deliveryInfo.isServiceable ? (
                            <>
                              ...
                              {getServiceTypeDiscount() > 0 && (
                                <p className="text-sm text-green-600 mt-1">🎉 Self service discount: Rp{getServiceTypeDiscount()}</p>
                              )}
                            </>
                          ) : (
                            <div className="text-center">
                ...
                <div className="space-y-4">
                    ...
                    {Object.entries(items).filter(([_, qty]) => qty > 0).map(([itemId, qty]) => {
                      ...
                      return (
                        <div key={itemId} className="flex justify-between text-sm">
                          ...
                          <span className="font-medium">Rp{(item?.basePrice || 0) * qty}</span>
                        </div>
                      )
                    })}
                  </div>
                  ...
                  <div className="p-4 bg-teal-50 rounded-xl">
                    ...
                    <div className="flex justify-between font-bold">
                      <span>Total</span>
                      <span className="text-teal-600">Rp{getTotalPrice() + (deliveryInfo?.deliveryCharge || 0)}</span>
                    </div>
                  </div>
                </div>
              )}
