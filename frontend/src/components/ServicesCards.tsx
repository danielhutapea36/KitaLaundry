      ...
      <StaggerContainer className="grid md:grid-cols-4 gap-4 mb-12">
        {data.map((service) => (
          <StaggerItem key={service.id}>
            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 text-center h-full">
              <div className="mb-4">
              ...
              <Button size="sm" className="bg-teal-500 hover:bg-teal-600 text-white px-6 w-full" onClick={onBookNow}>
                Pesan Sekarang
              </Button>
            </div>
          </StaggerItem>
