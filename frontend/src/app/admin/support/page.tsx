...
export default function AdminSupportPage() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: 'Navigate to Refunds page, find the pending refund request. If amount is within your limit (Rp500), you can approve directly. For amounts above Rp500, escalate to Center Admin. Click Approve/Reject/Escalate as needed.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Admin handles day-to-day operations like order management, customer support, and basic refunds (up to Rp500). Center Admin has full control including pricing, branch management, financial oversight, and unlimited refund approval.'
    },
    {
