                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="space-y-1 text-sm text-gray-600">
                        ...
                        <div className="flex items-center gap-4 flex-wrap text-gray-500">
                          ...
                          <span>Spent: <strong className="text-gray-700">Rp{customer.stats?.totalSpent?.toLocaleString() || '0'}</strong></span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-green-50 rounded-lg p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-green-600">Rp{selectedCustomer.stats?.totalSpent?.toLocaleString() || '0'}</p>
