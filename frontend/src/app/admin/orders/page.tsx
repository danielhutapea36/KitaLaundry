            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  {selectedOrder.pricing?.subtotal && <div className="flex justify-between py-2"><span className="text-gray-600">Subtotal</span><span>Rp{selectedOrder.pricing.subtotal.toLocaleString()}</span></div>}
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span>
                          {(selectedOrder.deliveryDetails?.deliveryCharge || selectedOrder.pricing?.deliveryCharge) === 0 
                            ...
                            : `Rp${selectedOrder.deliveryDetails?.deliveryCharge || selectedOrder.pricing?.deliveryCharge}`
                          }
                        </span>
                      </div>
                  ...
                  {selectedOrder.pricing?.discount && <div className="flex justify-between py-2 text-green-600"><span>Discount</span><span>-Rp{selectedOrder.pricing.discount}</span></div>}
                  <div className="flex justify-between py-2 border-t border-gray-200 font-bold text-lg"><span>Total</span><span>Rp{selectedOrder.pricing?.total?.toLocaleString()}</span></div>
                </div>
              </div>
            </div>
