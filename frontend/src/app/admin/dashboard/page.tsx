          ...
          <div className="flex items-center gap-4">
            ...
            {revenueData && (
              <div className="text-right">
                ...
                <p className="text-lg font-bold text-emerald-600">Rp{revenueData.totalRevenue?.toLocaleString()}</p>
              </div>
            )}
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="text-right">
                    ...
                    <div className="text-sm font-bold text-gray-800">Rp{order.pricing?.total?.toLocaleString()}</div>
                  </div>
                  <Link
