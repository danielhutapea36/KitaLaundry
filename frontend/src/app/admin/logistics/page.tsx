                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 flex flex-wrap gap-4 text-sm">
                        ...
                        <div className="text-gray-500">
                          Rate: Rp{partner.rateCard?.flatRate || 50}/order
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium">Rp{selectedPartner.rateCard?.flatRate || 50}/order</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Per Km Rate</span>
                      <span className="font-medium">Rp{selectedPartner.rateCard?.perKm || 0}/km</span>
                    </div>
                    <div className="flex justify-between items-center">
