...
import { FAQ_CATEGORIES_DATA, QUICK_HELP_CARDS_DATA, CATEGORY_TABS_DATA } from '@/data/dummyData'
...
export default function HelpPage() {
  ...
  const faqCategories = FAQ_CATEGORIES_DATA
  ...
  const quickHelpCards = QUICK_HELP_CARDS_DATA.map(card => ({
    ...card,
    link: isAuthenticated ? card.link : "/auth/login"
  }))

  const categoryTabs = CATEGORY_TABS_DATA
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 text-center border border-purple-100 hover:shadow-lg transition-all">
              ...
              <a href="mailto:support@kitalaundry.com" className="text-purple-600 font-semibold text-lg hover:text-purple-700">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-white">KitaLaundry</span>
            </div>
            ...
            <p className="text-sm">© 2024 KitaLaundry. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
