...
const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://kitalaundry-backend-605c.onrender.com/api'
      ...
      <div className="max-w-md w-full space-y-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="admin@kitalaundry.com"
                  />
                </div>
              </div>
        ...
        <div className="text-center">
          <p className="text-gray-400 text-sm">
            KitaLaundry Super Admin Portal
          </p>
