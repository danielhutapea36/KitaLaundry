                ...
                <div key={partner._id} className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      Rp{partner.rateCard.flatRate}/order
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 bg-purple-50 rounded-lg">
                  ...
                  <p className="text-sm text-purple-600 mt-1">
                    Rate: Rp{settlementData.partner.rateCard.flatRate}/order
                  </p>
                </div>
                ...
                <div className="p-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-white">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <div className="text-2xl font-bold">Rp{settlementData.settlement.pickupAmount}</div>
                    </div>
                    <div>
                      <div className="text-sm opacity-80">Delivery Amount</div>
                      <div className="text-2xl font-bold">Rp{settlementData.settlement.deliveryAmount}</div>
                    </div>
                    <div>
                      <div className="text-sm opacity-80">Total Payable</div>
                      <div className="text-3xl font-bold">Rp{settlementData.settlement.totalAmount}</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Flat Rate (Rp)</label>
                  <input
                    type="number"
                    value={form.flatRate}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Per Order (Rp)</label>
                  <input
                    type="number"
                    value={form.perOrder}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Per KM (Rp)</label>
                  <input
                    type="number"
                    value={form.perKm}
